...
I ![love](https://github.global.ssl.fastly.net/images/icons/emoji/heart.png) emojis. Among other contributions, I had the fun of adding emoji auto completion to the [latest GitHub for Windows release](http://haacked.com/archive/2014/06/09/ghfw-2/).
